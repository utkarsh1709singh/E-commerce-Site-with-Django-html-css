...
class Cart(BaseModel):
    ...
    def get_cart_total(self):
        ...
        if cart_items.color_varient:
           color_varient_price =cart_items.color_varient.price
           price.append(color_varient_price)
        if cart_items.size_varient:
            size_varient_price=cart_items.size_varient.price
